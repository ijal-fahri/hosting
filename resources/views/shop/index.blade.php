...
<x-layout>
    <section class="best-selling">
        ...
        <div class="products-container">
            ...
            <div class="product-card">
                ...
                <div class="desc-row">
                    <p class="description">
                        Sepatu dewasa dengan desain elegan dan bahan premium untuk kenyamanan maksimal.
                    </p>
                    <a href="{{ route('produkdetail.index') }}" class="buy">↗</a>
                </div>
            </div>
            ...
            <div class="product-card">
                ...
                <div class="desc-row">
                    <p class="description">
                        Didesain untuk performa optimal, sepatu sport ini memberikan dukungan ekstra saat berolahraga.
                    </p>
                    <a href="{{ route('produkdetail.index') }}" class="buy">↗</a>
                </div>
            </div>
            ...
            <div class="product-card">
                ...
                <p class="price">
                    ₹ 2999.00 
                    <span class="old-price">₹ 4499.00</span>
                </p>
                <div class="desc-row">
                    <p class="description">
                        Cocok untuk aktivitas sehari-hari, sepatu casual ini memberikan gaya dan kenyamanan.
                    </p>
                    <a href="{{ route('produkdetail.index') }}" class="buy">↗</a>
                </div>
            </div>
    ...
    <style>
        ...
        .description {
            ...
            max-width: 220px;               /* Pastikan ada ruang untuk tombol buy */
        }
