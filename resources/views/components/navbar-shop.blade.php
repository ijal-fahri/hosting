...
<head>
    ...
    <style>
        ...
        .animate-slideDrawer {
            animation: slideDrawer .3s ease forwards;
        }

        .animate-hideDrawer {
            animation: hideDrawer .3s ease forwards;
        }
        ...
        .animate-slideOops {
            animation: slideOops .3s ease forwards;
        }

        .animate-hideOops {
            animation: hideOops .3s ease forwards;
        }
    </style>
</head>
...
<body class="flex flex-col min-h-screen bg-gray-100">
    ...
    <header class="fixed top-0 left-0 w-full bg-white/90 backdrop-blur-md shadow-md z-20">
        <div class="max-w-7xl mx-auto px-4 md:px-8 py-4 flex items-center justify-between">
            <button onclick="window.location.href='/'"
                class="text-2xl font-extrabold hover:text-gray-700 focus:outline-none">Zoes</button>
            ...
            <div class="hidden md:flex items-center space-x-4">
                @auth
                    <button id="desktopSearchBtn"
                        class="p-2 rounded-full text-xl hover:text-gray-700 hover:bg-gray-200 focus:outline-none search-trigger">
                        <i class="fas fa-search"></i>
                    </button>
                    <!-- Cart icon -->
                    <a href="{{ route('cart.index') }}"
                        class="p-2 rounded-full text-xl hover:text-gray-700 hover:bg-gray-200 focus:outline-none">
                        <i class="fas fa-shopping-cart"></i>
                    </a>
                @else
                    <button onclick="showOopsDrawer()"
                        class="p-2 rounded-full text-xl hover:text-gray-700 hover:bg-gray-200 focus:outline-none">
                        <i class="fas fa-search"></i>
                    </button>
                    <!-- Cart icon untuk guest -->
                    <a href="javascript:void(0)" onclick="showOopsDrawer()"
                        class="p-2 rounded-full text-xl hover:text-gray-700 hover:bg-gray-200 focus:outline-none">
                        <i class="fas fa-shopping-cart"></i>
                    </a>
                @endauth
                <div class="relative inline-block">
                    <button id="userMenuBtn"
                        class="flex items-center gap-2 px-4 py-2 rounded-md shadow bg-gradient-to-r from-white/50 to-white/20 border border-white/30 hover:from-white/70 hover:to-white/40 transition-all">
                    ...
                    <div id="userDropdown"
                        class="hidden absolute top-full left-1/2 transform -translate-x-1/2 mt-2 w-52 bg-white text-gray-700 border border-gray-200 rounded-lg shadow-lg py-2 dropdown-enter">
                        @guest
                        ...
                        @else
                            ...
                            <a href="{{ route('logout') }}"
                                ...
                                class="flex items-center gap-2 px-4 py-2 hover:bg-gray-100 text-red-600 hover:text-red-800">
    ...
    <aside id="mobile-menu-drawer"
        class="fixed inset-y-0 left-0 w-64 bg-white shadow-md transform -translate-x-full z-50">
        <div class="p-4">
            ...
            <div class="mt-6 border-t pt-4">
                <button id="mobileUserBtn" class="flex items-center gap-2 w-full text-left text-lg focus:outline-none">
                    <i class="fas fa-user"></i> @guest Login / Register
                    @else
                    My Account @endguest
                </button>
        ...
        <footer class="mt-auto bg-black text-white">
            <div class="container mx-auto px-8 py-10 flex flex-wrap justify-between gap-8">
                ...
                <div class="flex-1 min-w-[250px]">
                    ...
                    <p class="mb-2">Temukan koleksi sepatu bayi terbaik untuk langkah kecil si kecil. Nyaman, stylish,
                        dan aman untuk menemani petualangan pertama mereka.</p>
                    <p class="mb-4">&copy; 2025 Zoes. Semua hak dilindungi.</p>
                    <div class="flex gap-4">
                        <a href="#" class="text-2xl hover:scale-110 transform transition"><i
                ...
                {{-- <div class="flex-1 min-w-[300px]">
                    ...
                    <form action="#" method="POST" class="flex flex-col gap-3">
                        ...
                        <textarea name="message" placeholder="Pesan Anda..." required
                            class="p-2 rounded-md bg-gray-200 text-black placeholder-black focus:outline-none h-24 resize-none"></textarea>
                        <button type="submit"
    ...
    <div id="oopsDrawer"
        class="hidden fixed inset-y-0 right-0 w-full sm:w-96 bg-white shadow-2xl z-50 flex flex-col animate-slideOops"
        ...
        <div class="p-6 flex-1 flex flex-col justify-center items-center text-center">
            ...
            <p class="mb-6">
                ...
                <a href="{{ route('register') }}" class="underline text-blue-500">Register</a> untuk mengakses
                halaman ini.
            </p>
            <button onclick="hideOopsDrawer()"
    ...
    <!-- search modal -->
    <div id="searchModal"
        class="fixed inset-0 z-50 hidden flex items-start justify-center pt-10 px-4 bg-white/95 animate-fadeIn">
        <div class="relative w-full max-w-md p-6 bg-white rounded-xl shadow-2xl animate-zoomIn">
            <button id="closeSearch"
                class="absolute top-3 right-3 text-2xl text-gray-700 hover:text-gray-900 focus:outline-none">
            ...
            <div class="relative">
                ...
                <input id="searchInput" type="text" placeholder="Cari Produk..."
                    class="w-full pl-10 p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 transition" />
            </div>
        </div>
    </div>
